  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      >
        ...
        <Typography variant="h5" color="textPrimary" gutterBottom display="flex" justifyContent="center" alignItems="center" textAlign="center">
        ...
        <Box mt={2}>
          <Typography variant='body2' color="grey">
            Forgot your login details?<Link href="/reset-password"> 
              <strong> Get help logging in.</strong></Link>
          </Typography>
        </Box>
        ...
        <Box mb={2} mt="auto">
          <Typography variant='body2' color="grey" justifyContent="center" alignItems="center">
            Don't have an account? <Link href="/register"><strong>Sign up.</strong></Link>
          </Typography>
        </Box>
      </Box>
    </ThemeProvider>
